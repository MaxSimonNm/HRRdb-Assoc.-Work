...
cd /home/bioinfo/Nilesh/HRRdb_Samples/HRR_G+_VCFs_Elucidata/Germline/
input="/home/bioinfo/Nilesh/HRRdb_Samples/HRR_G+_VCFs_Elucidata/Germline/ls.txt"
...
perl /home/bioinfo/Nilesh/HRRdb_Samples/Scripts/annotation/config.pl ${line}/${line}   2 > telegram-send "Error at {$line}'s Config File"
...
telegram-send "File Annotation Finished"
